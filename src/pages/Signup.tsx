...
const Signup = () => {
  ...
  return (
    <div>
      <section className="bg-white dark:bg-gray-900 max-sm:w-full h-screen ">
        <div className=" lg:grid lg:min-h-screen lg:grid-cols-12">
          <section
            className="relative flex h-32 items-end bg-gray-900 
          md:h-[15rem]   lg:col-span-5 lg:h-full xl:col-span-6"
          >
            <img
              alt=""
          ...
          <main className="flex items-center justify-center  max-sm:px-0 px-8 py-8 sm:px-12 lg:col-span-7 lg:px-16 lg:py-12 xl:col-span-6">
